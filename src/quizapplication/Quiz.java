...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String username){
        ...
        qno = new JLabel();
        qno.setBounds(30,355,70,20);
        qno.setFont(new Font("Tahoma",Font.PLAIN,22));
        add(qno);
        
        question = new JLabel();
        question.setBounds(100,350,800,30);
        ...
        next.setBounds(1000,400,150,30);
        ...
        lifeline.setBounds(1000,480,150,30);
        ...
        submit.setBounds(1000,560,150,30);
